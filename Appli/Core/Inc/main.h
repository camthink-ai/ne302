...
#define MM_HALOW_SPI_IRQ_Pin GPIO_PIN_11
#define MM_HALOW_SPI_IRQ_GPIO_Port GPIOG
...
#define MM_HALOW_SPI_IRQn            (EXTI11_IRQn)
#define MM_HALOW_SPI_IRQ_HANDLER     EXTI11_IRQHandler
